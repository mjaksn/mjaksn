...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| nettail | 0.7.0 | v0.6.0 | all 13 | 2 commits | success | 1 | dependabot/docker/python-3.14.7-slim (+1/-1) | PyPI 0.7.0, GHCR missing 0.7.0, Docker Hub missing 0.7.0 |
...
| readerboard | 0.3.0 | v0.3.0 | all 6 | none | success | 0 | none | PyPI 0.3.0, GHCR 0.3.0, Docker Hub 0.3.0 |
