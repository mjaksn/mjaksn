...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| nettail | 0.18.0 | v0.17.0 | all 22 | 7 commits | success | 1 | dependabot/docker/python-cad9a2c (+1/-3), mac-docs (+2/-16) | PyPI 0.17.0, GHCR missing 0.18.0, Docker Hub missing 0.18.0 |
...
| readerboard | 0.6.0 | v0.6.0 | all 9 | 7 commits | success | 1 | dependabot/pip/anyio-gte-4.14.2-and-lt-4.16 (+1/-14), pool-from-sign (+3/-7) | PyPI 0.6.0, GHCR 0.6.0, Docker Hub 0.6.0 |
...
<sub>Generated: 2026-09-16 05:19 UTC</sub>
...
<sub>Checked: 2026-09-11 12:17 UTC</sub>
