...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| nettail | 0.19.0 | v0.19.0 | all 24 | none | success | 0 | mac-docs (+2/-24) | PyPI 0.19.0, GHCR 0.19.0, Docker Hub 0.19.0 |
...
| readerboard | 0.6.0 | v0.6.0 | all 9 | 8 commits | success | 2 | dependabot/pip/anyio-gte-4.14.2-and-lt-4.16 (+1/-15), dependabot/pip/uvicorn-gte-0.52.1-and-lt-0.54 (+1/-0), pool-from-sign (+3/-8) | PyPI 0.6.0, GHCR 0.6.0, Docker Hub 0.6.0 |
...
| toolshed | none | none | none | n/a | success | 1 | dependabot/pip/dot-github/ruff-0.16.8 (+1/-1) | none |

<sub>Generated: 2026-09-26 11:57 UTC</sub>
...
- toolshed: [ci: bump ruff from 0.16.6 to 0.16.7 in /.github](https://github.com/mjaksn/toolshed/pull/26)

<sub>Checked: 2026-09-19 11:59 UTC</sub>
