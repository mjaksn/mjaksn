...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| nettail | 0.18.0 | v0.17.0 | all 22 | 7 commits | success | 3 | dependabot/docker/python-cad9a2c (+1/-3), dependabot/pip/netflume-gte-0.5.2-and-lt-0.7 (+1/-0), mac-docs (+2/-16), restore-thread (+13/-0) | PyPI 0.17.0, GHCR missing 0.18.0, Docker Hub missing 0.18.0 |
...
| toolshed | none | none | none | n/a | success | 2 | add-smtp-sink (+6/-0), dependabot/pip/dot-github/ruff-0.16.7 (+1/-0) | none |
...
<sub>Generated: 2026-09-22 12:13 UTC</sub>
