...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| nettail | 0.11.0 | v0.11.0 | all 15 | none | success | 2 | changelog-0-10-0-link (+1/-0), dependabot/docker/python-3.14.7-slim (+1/-4) | PyPI 0.11.0, GHCR 0.11.0, Docker Hub 0.11.0 |
