...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| nettail | 0.6.0 | v0.6.0 | all 12 | 1 commit | success | 0 | none | PyPI 0.6.0, GHCR 0.6.0, Docker Hub 0.6.0 |
...
| readerboard | 0.2.0 | v0.2.0 | all 5 | 3 commits | success | 0 | none | PyPI 0.2.0, GHCR 0.2.0, Docker Hub 0.2.0 |
